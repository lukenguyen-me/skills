...
expected_marketplace_skills='["./skills/scaffold-repository","./skills/using-github","./skills/new-branch","./skills/develop-issue","./skills/finish-pr","./skills/pr-feedback-loop","./skills/review-code","./skills/update-branch","./skills/install-skills"]'
